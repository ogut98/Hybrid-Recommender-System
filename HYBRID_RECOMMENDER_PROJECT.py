...
movie = pd.read_csv(r'C:\Users\NUR\Desktop\DTS02\movie.csv')
movie.head()
movie.shape

# UserID, film adı, filme verilen oy ve zaman bilgisini içeren veri seti
rating = pd.read_csv(r'C:\Users\NUR\Desktop\DTS02\rating.csv')
rating.head()
rating.shape
...
movies_watched_df.shape  # 186 film seçildi
# user_movie_df.shape => 3159 film vardı
...
recommendation_df.loc[recommendation_df["weighted_rating"] > 3.5]
movies_to_be_recommend = recommendation_df[recommendation_df["weighted_rating"] > 3.5].sort_values("weighted_rating", ascending=False)


# Adım 4:  Tavsiye edilen 5 filmin isimlerini getiriniz.
movies_to_be_recommend.merge(movie[["movieId", "title"]], on="movieId")["title"][:5]
